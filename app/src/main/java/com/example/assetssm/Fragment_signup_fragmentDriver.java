...
public class Fragment_signup_fragmentDriver extends Fragment {
    private static TextView textToolHeader;
    View view;
    Toolbar toolbar;

    public Fragment_signup_fragmentDriver() {
    }
...
//            item.setVisible(false);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_signup_fragmentdriver, container, false);
        return view;
    }
}
