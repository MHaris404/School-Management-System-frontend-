...
public class Fragment_mainProfileStaffAdminTimetable_tTableGenerator extends Fragment implements StepperFormListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_mainprofilestaffadmintimetable_ttablegenerator, container, false);
...
//    //class extended in jga of Fragment
//    @Override
