...
public class Fragment_mainProfileStaffAdminBook extends Fragment {
    Toolbar toolbar;
    ...
    FloatingActionButton FAB_admin_bookGrade;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mainprofilestaffadminbook, container, false);
        ...
        FAB_admin_bookGrade = view.findViewById(R.id.FAB_admin_bookGrade);
        bookAdder();
    ...
    private void bookAdder() {
        FAB_admin_bookGrade.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment_mainProfileStaffAdminBook_bookAdder instAdder = new Fragment_mainProfileStaffAdminBook_bookAdder();
